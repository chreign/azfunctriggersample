...
public class HttpTriggerSample {
     ...
     * HttpTrigger Key is not needed when running locally, it is used to invoke function deployed to Azure.
     * More details: https://aka.ms/functions_authorization_keys
     */
    @FunctionName("azfunctionthttp")
    public HttpResponseMessage run(
        ...
        context.getLogger().info("azfunctiontimer HTTP trigger processed a request.");
